...
<div
  class="fixed bottom-0 h-max w-full bg-nav-100 z-50 backdrop-blur-xl rounded-tl-xl rounded-tr-xl px-8 pt-4 pb-32 data-[active='false']:translate-y-[100%]
    transition ease-ios-smooth duration-700 hidden text-zinc-800
    dark:text-zinc-300 dark:bg-nav-800
...
>
  ...
  <div class="flex flex-col">
    <a
      ...
      target="_blank"
      class="bg-background-400/50 dark:bg-background-700/50 rounded-tl-md rounded-tr-md py-4 px-4 flex justify-between items-center md:gap-24 fill-zinc-300 hover:bg-background-500/20 dark:hover:bg-background-500/50"
    >
      <div class="flex gap-4 items-center">
        <svg
          ...
          height="1em"
          viewBox="0 0 384 512"
          class="w-5 h-5 fill-zinc-800 dark:fill-zinc-400"
          ><!--! Font Awesome Free 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path
      ...
      <svg
        ...
        height="1em"
        viewBox="0 0 512 512"
        class="fill-zinc-800 dark:fill-zinc-400"
        ><!--! Font Awesome Free 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path
          d="M320 0c-17.7 0-32 14.3-32 32s14.3 32 32 32h82.7L201.4 265.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L448 109.3V192c0 17.7 14.3 32 32 32s32-14.3 32-32V32c0-17.7-14.3-32-32-32H320zM80 32C35.8 32 0 67.8 0 112V432c0 44.2 35.8 80 80 80H400c44.2 0 80-35.8 80-80V320c0-17.7-14.3-32-32-32s-32 14.3-32 32V432c0 8.8-7.2 16-16 16H80c-8.8 0-16-7.2-16-16V112c0-8.8 7.2-16 16-16H192c17.7 0 32-14.3 32-32s-14.3-32-32-32H80z"
        /></svg
      >
    </a>
    <div class="h-[1px] bg-background-400 dark:bg-background-500">
      <!-- Horizontal Line -->
    </div>
    <a
      ...
      target="_blank"
      class="bg-background-400/50 dark:bg-background-700/50 rounded-bl-md rounded-br-md py-4 px-4 flex justify-between items-center fill-zinc-300 hover:bg-background-500/20 dark:hover:bg-background-500/50"
    >
      <div class="flex gap-4 items-center">
        <svg
          xmlns="http://www.w3.org/2000/svg"
