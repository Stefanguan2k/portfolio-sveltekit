<footer
  class="h-full py-8 px-4 bg-background-200 dark:bg-background-700 rounded-2xl flex justify-between items-center gap-6 mb-64
    md:px-10"
>
  <div class="flex flex-col items-center gap-4 md:flex-row">
    <div>© Stefan Guan 2023</div>
    <div class="flex gap-4">
      <a
        href="https://www.linkedin.com/in/stefan-guan-a72224228/"
        class="p-3 dark:bg-background-600 rounded-full fill-zinc-700 bg-background-400 dark:fill-zinc-300 dark:hover:bg-background-500 hover:bg-zinc-400 hover:shadow-xl transition ease-ios-smooth"
        target="_blank"
      >
        <svg
  ...
  <div class="flex flex-col gap-4 items-center md:flex-row">
    <div>Crafted with love using</div>
    <div class="flex gap-4">
      <a
        href="https://kit.svelte.dev/"
        class="p-3 dark:bg-background-600 rounded-full bg-background-400 dark:hover:bg-background-500 hover:bg-zinc-400 hover:shadow-xl transition ease-ios-smooth"
        target="_blank"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
...
<!-- flex flex-col gap-6 text-zinc-800 dark:text-zinc-200 max-w-[1280px] m-auto mb-64 -->
