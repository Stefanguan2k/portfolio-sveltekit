<div
  class="max-w-[1280px] text-zinc-800 dark:text-zinc-200 mx-auto mb-32 mt-6 md:pl-24"
>
  <footer
    class="h-full py-8 px-4 bg-background-200 dark:bg-background-700 rounded-2xl flex justify-between items-center gap-6
    md:px-10"
  >
